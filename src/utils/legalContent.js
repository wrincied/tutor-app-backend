...
const DATENSCHUTZ_BODY = [
  ...
  '- Anschrift: **Köflacher Gasse 9, Tür 218.2, 8020 Graz, Österreich**',
  ...
  '',
  'Zur Ausübung Ihrer Rechte kontaktieren Sie uns unter **support@simple4u.at**.',
  '',
  '## 12. Beschwerderecht',
  '',
...
const DEFAULT_LEGAL = Object.freeze({
  ...
  impressum: {
    ...
    body: [
      ...
      'Gewerbebehörde / Behörde gem. ECG: Magistrat der Stadt Graz',
      'GISA-Zahl: 39994318',
      ...
      '',
      'Mitglied der Wirtschaftskammer Österreich (WKO), Landeskammer Steiermark',
      'Firmen A–Z: https://firmen.wko.at/arsen-mileuski/steiermark/?firmaid=7353608f-0542-4b19-b119-0dfe10e759db',
