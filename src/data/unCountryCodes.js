/** ISO 3166-1 alpha-2 — государства — члены ООН (193). Синхронно с frontend un-country-codes.ts */
const UN_MEMBER_COUNTRY_CODES = [
  ...
  'SR', 'SE', 'CH', 'SY', 'TJ', 'TH', 'TL', 'TG', 'TO', 'TT', 'TN', 'TR', 'TM', 'TV', 'UG',
  'UA', 'AE', 'GB', 'TZ', 'US', 'UY', 'UZ', 'VU', 'VE', 'VN', 'YE', 'ZM', 'ZW',
];

const UN_MEMBER_COUNTRY_CODE_SET = new Set(UN_MEMBER_COUNTRY_CODES);
